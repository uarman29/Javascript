...
<html>
	<head> 
		...
		<?php include "updater.php"?>
			...
			function initialize()
			{
				...
				titleElement.innerHTML="<?php getTime("Name","2");?>";
				messageElement.innerHTML="<?php getTime("Time","2");?>";
				Health=<?php getValue("Health");?>
				Oxygen=<?php getValue("Oxygen");?>
				BodyTemp=<?php getValue("BodyTemp");?>
				Temp=<?php getValue("Temp");?>
				Data=<?php getTable();?>;
				obtained=<?php checkPeice("p3");?>;
				checkPeice();
				fillTable();
			...
			function randomAttack()
			{
				...
				statusElement.innerHTML+="<br/>"+"DINO ATTACK";
				checkHealth("Yes");
			...
			function checktemp()
			{
				if(<?php getTime("Temp","2");?>>=30&&<?php getTime("Temp","2");?><=125)
				{
					Temp=5;
					sendRequest("Temp",Temp);
					return;
				}
				if(<?php getTime("Temp","2");?><=30)
				{
					Temp=0;
					sendRequest("Temp",Temp);
				}
				if(<?php getTime("Temp","2");?>>=125)
				{
					Temp=10;
					sendRequest("Temp",Temp);
				}
	...
	<img id="back"src="Images/JurrasicBack.jpg"/>
	<img id="attack"src="Images/JurrassicAttack.png"/>
	<form id="myForm" method ="post" action="Portal.php">
		...
		<img id="image" style="position:absolute;height:3%;width:2%;"src="Images/p3.png" onmousedown="getItem('Yes');"onmouseup="getItem('No');"/>
	</form>
