...
<html>
	<head> 
		...
		<?php include "updater.php"?>
			...
			function initialize()
			{
				...
				titleElement.innerHTML="<?php getTime("Name","5");?>";
				messageElement.innerHTML="<?php getTime("Time","5");?>";
				Health=<?php getValue("Health");?>
				Oxygen=<?php getValue("Oxygen");?>
				BodyTemp=<?php getValue("BodyTemp");?>
				Temp=<?php getValue("Temp");?>
				Data=<?php getTable();?>;
				obtained=<?php checkPeice("p6");?>;
				checkPeice();
				fillTable();
				setInterval(randomAttack,getRandomInteger(2000,4000));
			...
			function randomAttack()
			{
				...
				statusElement.innerHTML+="<br/>"+"Someone Cut You";
				checkHealth("Yes");
			...
			function checktemp()
			{
				if(<?php getTime("Temp","5");?>>=30&&<?php getTime("Temp","5");?><=125)
				{
					Temp=5;
					sendRequest("Temp",Temp);
				}
				if(<?php getTime("Temp","5");?><=30)
				{
					Temp=0;
					sendRequest("Temp",Temp);
				}
				if(<?php getTime("Temp","5");?>>=125)
				{
					Temp=10;
					sendRequest("Temp",Temp);
				}
	...
	<img id="back"src="Images/MongolsBack.jpg"/>
	<img id="attack"src="Images/MongolsAttack.png"/>
	<form id="myForm" method ="post" action="Portal.php">
		...
		<img id="image" style="position:absolute;height:3%;width:2%;"src="Images/p6.png" onmousedown="getItem('Yes');"onmouseup="getItem('No');"/>
	</form>
