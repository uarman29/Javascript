...
<html>
	<head> 
		...
		<?php include "updater.php"?>
			...
			function initialize()
			{
				...
				titleElement.innerHTML="<?php getTime("Name","1");?>";
				messageElement.innerHTML="<?php getTime("Time","1");?>";
				Health=<?php getValue("Health");?>
				Oxygen=<?php getValue("Oxygen");?>
				BodyTemp=<?php getValue("BodyTemp");?>
				Temp=<?php getValue("Temp");?>
				Data=<?php getTable();?>;
				obtained=<?php checkPeice("p2");?>;
				checkPeice();
				fillTable();
			...
			function checktemp()
			{
				if(<?php getTime("Temp","1");?>>=30&&<?php getTime("Temp","1");?><=125)
				{
					Temp=5;
					sendRequest("Temp",Temp);
					return;
				}
				if(<?php getTime("Temp","1");?><=30)
				{
					Temp=0;
					sendRequest("Temp",Temp);
				}
				if(<?php getTime("Temp","1");?>>=125)
				{
					Temp=10;
					sendRequest("Temp",Temp);
				}
	...
	<img id="back"src="Images/SnowballBack.jpg"/>
	<form id="myForm" method ="post" action="Portal.php">
		...
		<img id="image" style="position:absolute;height:3%;width:2%;"src="Images/p2.png" onmousedown="getItem('Yes');"onmouseup="getItem('No');"/>
	</form>
